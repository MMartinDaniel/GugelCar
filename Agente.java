    ...
    */
    public boolean login(){
        ...
        try {
            ...
            jsonLogin.put("radar", "agentep12");
            jsonLogin.put("scanner", "agentep12");
            jsonLogin.put("battery", "agentep12"); 
        ...
        if(!found){
            ...
            for(int i=0; i < 8; i++){
                if(posibles_movimientos[i] == true){
                    switch(i){
                        case 0:
                            for(int j=0; j < rastro.size(); j++){
                                Posicion p = rastro.get(j);
                                
                                if(p.x == this.MenY-1 && p.y == this.MenX-1 && p.num_veces >= 5){
                                    System.out.println("Ya hemos pasado por " + (this.MenY-1) + "," + (this.MenX-1) + " al menos 5 veces. La eliminamos");
                                    distancias[i] = 1000.0;
                                }
                            }
                            break;
                        case 1:
                            for(int j=0; j < rastro.size(); j++){
                                ...
                                if(p.x == this.MenY-1 && p.y == this.MenX && p.num_veces >= 5){
                                    System.out.println("Ya hemos pasado por " + (this.MenY-1) + "," + (this.MenX) + " al menos 5 veces. La eliminamos");
                                    distancias[i] = 1000.0;
                                }
                            }
                            break;
                        ...
                        case 3:
                            for(int j=0; j < rastro.size(); j++){
                                ...
                                if(p.x == this.MenY && p.y == this.MenX-1 && p.num_veces >= 5){
                                    System.out.println("Ya hemos pasado por " + (this.MenY) + "," + (this.MenX-1) + " al menos 5 veces. La eliminamos");
                                    distancias[i] = 1000.0;
                                }
                            }
                            break;
